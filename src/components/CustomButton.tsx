...
const CustomButton = (props: ButtonProps) => {
  ...
  const { buttonText, style, children, activeOpacity, showLoading, disabled } = props;
  ...
  >
    ...
    {showLoading?
     ...
     <Spinner
        ...
        :
        buttonText &&
          <CtText style={[darkTheme ? null : {color: defaultColors.white}, {fontWeight: "600",
          fontFamily:'Figtree-SemiBold', fontSize: 18}]}>{buttonText}</CtText>
      }
  </TouchableOpacity>
  );
};
